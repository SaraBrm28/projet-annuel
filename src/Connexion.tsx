...
const inscription = () => {
            ...
            <main className="flex-grow flex justify-center items-center pt-28 pb-64 p-8">
              ...
              <div className=" items-center w-1/3 ">
                <div className="  glass-morphism-two p-8  rounded-2xl ">
                  <h2 className=" place-self-center  text-2xl font-bold mb-6">CONNEXION</h2>
                  <form>
                    <div className="mb-4">
    ...
    <Button variant={'primary'} > se connecter</Button>
                  ...
                  <p className="mt-4 text-center text-sm">
                    Vous n'avez pas de compte ? <a href="#" className="text-fuchsia-400 hover:underline">S'inscrire</a>
                  </p>
                </div>
              </div>
            </main>
